...
class Train_model_frontend_pl(object):
    ...
    @staticmethod
    def getMasksStatic(mask_2D, cell_size, device="cpu"):
        """
    ...
    @staticmethod
    def tb_images_dictStatic(task, tb_imgs, max_img=5):
        """
        # add image dictionary to tensorboard
        :param task:
            str (train, val)
    ...
    @staticmethod
    def printLossesStatic(losses, task="training"):
        """
        # print loss for tracking training
        :param losses:
        :param task:
