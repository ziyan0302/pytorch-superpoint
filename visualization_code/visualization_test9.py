"""
this would be written for image experiment
Visaulization code:
...
6. show the error with gt on the same image
"""
import pdb
import numpy as np
import torch
...
filename = "/home/ziyan/02_research/pytorch-superpoint/configs/superpoint_mvsecImg_test_heatmap.yaml"
...
pretrained_path = "/home/ziyan/02_research/pytorch-superpoint/logs/superpoint_mvsecImg/2024-08-02_05-28/checkpoints/superPointNet_8000_checkpoint.pth.tar"
...
for index, sample in tqdm(enumerate(data_iter)):
    ...
    if (0): # randomly filter out some interest points
        sample_rate = 21
